    ...
    public function test_public_session_code_shows_uploaded_original_and_framed_assets(): void
    {
        ...
        $this->get('/SES-NTRPXPBS')
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('session.og.title', 'Session Test - SES-NTRPXPBS | Dafydio Photobooth')
                ->where('session.og.description', 'Lihat, download, dan cetak ulang foto session SES-NTRPXPBS dari Dafydio Cloud.')
                ...
                ->where('session.og.canonical', route('public.sessions.show', ['sessionCode' => 'SES-NTRPXPBS']))
                ->has('assets', 2)
